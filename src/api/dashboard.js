...
// Summary is computed client-side from the user's own Supabase rows
// (profiles, skills, saved_roles). Trends come from the career-ai
// Edge Function. Both resolve to `{ data }` for the existing UI.
...
export async function getSummary() {
  ...
  // Simple completeness heuristic out of 100.
